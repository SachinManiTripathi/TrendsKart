  ...
  return (
   <footer className="bg-gray-800 text-white py-8 px-4 md:px-16 lg:px-24">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          <h3 className="text-xl font-semibold">TrendsKart</h3>
          <p className="mt-4">
            Your one-step solution for all ur needs. Shop with us and experience the best online shopping experience.
          </p>
        </div>
      ...
      <div className="flex  items-center justify-center mt-10">
          <p className="text-grey-200 ">&copy; 2025 TrendsKart: All rights reserved </p>
      </div>
   </footer>
  )
}
